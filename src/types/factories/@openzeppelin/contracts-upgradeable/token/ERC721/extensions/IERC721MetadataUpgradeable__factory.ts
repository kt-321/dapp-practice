...
export class IERC721MetadataUpgradeable__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): IERC721MetadataUpgradeable {
    return new Contract(address, _abi, signerOrProvider) as IERC721MetadataUpgradeable;
  }
}
